<%@ page import="com.bjpowernode.oa.bean.Staff" %>
	...
	<ul>
		...
		<div class="main">
			<table border="1px" align="center" width="100%" height="100%">
				...
				<%
					List<Staff> staffList = (List<Staff>) request.getAttribute("deptList1");
					// 循环遍历
					int i = 0;
...
//					out.write(dept.getDname());
				...
				<tr>
					<td class="td1"><%=++i%></td>
					<td class="td2"><%=staff.getDname()%></td>
					<td class="td2"><%=staff.getName()%></td>
					<td class="td2"><%=staff.getTime()%></td>
					<td class="td2"><%=staff.getJob()%></td>
				</tr>
				<%
					}
				%>
